...
export function useKeymapConfig() {
  ...
  return {
    ...
    touchOnThreshold: touchpadConfig.touchOnThresholdValue,
    touchOffThreshold: touchpadConfig.touchOffThresholdValue,
    handleTouchOnThresholdChange: touchpadConfig.handleTouchOnThresholdChange,
    handleTouchOffThresholdChange: touchpadConfig.handleTouchOffThresholdChange,
    touchTrackball: touchpadConfig.touchTrackballValue,
    handleTouchTrackballChange: touchpadConfig.handleTouchTrackballChange,
    touchTrackballFriction: touchpadConfig.touchTrackballFrictionValue,
    handleTouchTrackballFrictionChange: touchpadConfig.handleTouchTrackballFrictionChange,
    leftGripOnMs: touchpadConfig.leftGripOnMsValue,
    leftGripOffMs: touchpadConfig.leftGripOffMsValue,
    rightGripOnMs: touchpadConfig.rightGripOnMsValue,
    rightGripOffMs: touchpadConfig.rightGripOffMsValue,
    handleLeftGripOnMsChange: touchpadConfig.handleLeftGripOnMsChange,
    handleLeftGripOffMsChange: touchpadConfig.handleLeftGripOffMsChange,
    handleRightGripOnMsChange: touchpadConfig.handleRightGripOnMsChange,
    handleRightGripOffMsChange: touchpadConfig.handleRightGripOffMsChange,
    ...
    touchpadLiftoffRatioValue: touchpadConfig.touchpadLiftoffRatioValue,
    touchpadPositionFallbackValue: touchpadConfig.touchpadPositionFallbackValue,
