...
export function useKeymapConfig() {
  ...
  return {
    ...
    leftGripRangeValue: gripConfig.leftGripRangeValue,
    rightGripRangeValue: gripConfig.rightGripRangeValue,
    handleLeftGripRangeChange: gripConfig.handleLeftGripRangeChange,
    handleRightGripRangeChange: gripConfig.handleRightGripRangeChange,
